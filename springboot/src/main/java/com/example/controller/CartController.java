...
public class CartController {
    ...
    public Result calc(@RequestParam Integer userId,@RequestParam Integer businessId){
        AmountDTO calc = cartService.calc(userId, businessId);
        return Result.success(calc);
    }

    /**
     * 清空购物车
     */
    @DeleteMapping("/detByBusinessId/{businessId}/{userId}")
    public Result detByBusinessId(@PathVariable Integer businessId, @PathVariable Integer userId){
        try {
