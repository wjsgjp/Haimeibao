<template>
	<view style="padding: 20rpx;">
		<view class="box">
			<uni-forms :model="form" :rules="rules" ref="formRef" label-width="140rpx" label-align="right">
				<uni-forms-item label="头像" name="avatar">
					<uni-file-picker limit="1" :image-styles="imageStyles" :del-icon="true" :disable-preview="false"
						file-mediatype="image" v-model="avatar" @select="handleAvatarUploadSuccess"></uni-file-picker>
	...
	export default {
		...
		methods: {
			...
			handleAvatarUploadSuccess(e) {
				...
				uni.uploadFile({
					url: 'http://localhost:9090/files/upload', //自己的后端接口（默认发送post请求）
					filePath: filePath,
