<template>
	<view style="padding: 20rpx;">
		...
		<view class="box" style="margin: 20rpx 0;" @click="toAddress">
			<view v-if="addressId">
		...
		<view class="box" style="margin: 20rpx 0;">
			...
			<view v-if="amount.discount">
				<view style="text-align: right;">
					...
					<text style="color: red; font-size: 36rpx; font-weight: bold;">￥{{ amount.money }}</text>
				</view>
			</view>
		</view>
		<!-- 购物车商品和金额信息 -->
		...
		<view class="box" style="margin: 20rpx 0;">
			...
			<view style="display: flex; margin-bottom: 10rpx;">
				...
				<navigator url="/pages/remark/remark" style="flex: 1; text-align: right; color: #999;">
					<text v-if="comment">{{ comment }}</text>
					<text v-else>请填写口味偏好</text>
					<uni-icons type="right" color="#999" style="position: relative; top: 5rpx;"></uni-icons>
				</navigator>
			</view>
		</view>
		<!-- 商家承诺 -->
		...
		<view  class="box" style="position: fixed; bottom: 0; width: 100%; left: -40rpx;">
			<view style="text-align: right;">
				...
				<text style="margin-left: 20rpx;">小计</text>
				<text style="color: red; font-size: 36rpx; font-weight: bold;">￥{{ amount.money }}</text>
				<button size="mini" type="primary" @click="addOrder()" style="margin-left: 20rpx; 
					background-color: dodgerblue; border-color: dodgerblue; position: relative; top: 18rpx;">提交订单</button>
			</view>
		</view>
		<!-- 提交按钮 -->
