<template>
	<view style="padding: 40rpx;">
		<view
			...
			<view style="margin: 50rpx 224rpx; font-size: 40rpx;">欢迎注册</view>
			<uni-forms ref="form" :rules="rules" :modelValue="form" validateTrigger='blur'>
				...
				<uni-forms-item>
					<button @click="register()"
						style="background-color: #ffd100; border-color: #ffd100; height: 70rpx; line-height: 70rpx;">
						注册</button>
				</uni-forms-item>
				<uni-forms-item>
					<view style="text-align: right;">已有账号？去 <navigator style="display: inline-block; color: dodgerblue; 
										margin-left: 8rpx;" url="/pages/login/login">登录</navigator>
					</view>
				</uni-forms-item>
			</uni-forms>
		</view>
