<template>
	<view style="padding: 20rpx;">
		<view style="margin-bottom: 110rpx;" v-if="addressList.length != 0">
		...
		<view v-else>当前还没有地址可以使用，快去添加地址吧~</view>
		
		<navigator url="/pages/addAddr/addAddr">
			<button type="primary" style="background-color: #ffd100; border-color: #ffd100;
				position: fixed; bottom: 10rpx; width: calc(100% - 40rpx); color: black;">新增收货地址</button>
		</navigator>
	</view>
</template>
