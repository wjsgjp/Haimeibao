	...
	<view style="padding: 20rpx;">
		...
		<view class="box" style="margin-bottom: 20rpx;">
			...
			<view style="display: flex;">
				<navigator url="/pages/address/address" class="me-item">
					<image src="@/static/icon/地址.png" style="width: 50%;" mode="widthFix"></image>
					<view>收货地址</view>
				</navigator>
				<navigator url="/pages/collect/collect" class="me-item">
					<image src="@/static/icon/收藏.png" style="width: 50%;" mode="widthFix"></image>
					<view>我的收藏</view>
				</navigator>
				<navigator url="/pages/commentCenter/commentCenter" class="me-item">
					<image src="@/static/icon/评价.png" style="width: 50%;" mode="widthFix"></image>
					<view>评价中心</view>
				</navigator>
				<!-- <navigator url="" class="me-item">
					<image src="@/static/icon/查看.png" style="width: 50%;" mode="widthFix"></image>
					<view>浏览历史</view>
				</navigator> -->
			</view>
		</view>
		...
		<view class="box">
			...
			<navigator url="/pages/aboutUs/aboutUs" style="padding: 15rpx; border-bottom: 2rpx solid #eee;">
				...
				<text style="margin-left: 10rpx;">申请成为骑手</text>
				<uni-icons type="right" color="#999" style="float: right;"></uni-icons>
			</navigator>
			<navigator url="/pages/agreement/agreement" style="padding: 15rpx; border-bottom: 2rpx solid #eee;">
				...
				<text style="margin-left: 10rpx;">商家入驻</text>
				<uni-icons type="right" color="#999" style="float: right;"></uni-icons>
			</navigator>
